...
\midrule
\textbf{Mean macro-F1} & \textbf{57.1} & \textbf{56.1} & \textbf{45.2} & \textbf{66.7} & \textbf{66.8} \\
\textbf{Mean accuracy} & \textbf{71.1} & \textbf{69.0} & \textbf{58.1} & \textbf{77.9} & \textbf{77.9} \\
\bottomrule
\end{tabular}}
...
Bottom rows: mean over all 11 datasets.}
\label{tab:learned}
\end{table}
