...
\emph{warm-started} from the biological graph. Our controlled study spans 13
datasets ($9$ genomap single-cell suites and $4$ Reactome/P-NET multi-omics
...
66.5\% ($+12.0$ points over a no-prior router and well above
a degree-matched random graph, 52.9\%), the decisive routing result;
...
(39.5\% vs.\ 52.9\% on single cell) and collapses on several suites,
...
it lifts single-cell macro-F1 to 66.5\% ($+12.0$ points over
...
\item We evaluate on all 13 datasets -- $9$ genomap single-cell suites
(Baron, Lung, Muraro, Oesophagus, Segerstolpe, Spleen, T-cell, Wang, Xin) and $4$
...
\section{Experiments}
\subsection{Setup}
We evaluate on all 13 datasets. The $9$ \textbf{genomap single-cell}
...
tasks. The $4$ \textbf{Reactome/P-NET multi-omics cohorts} -- prostate, BLCA, STAD
...
Table~\ref{tab:uq}: no. Every table is multi-seed over the full 13-dataset suite.
...
66.5\% ($81.3\%$ accuracy), $+12.0$ points over
the no-prior router (54.5\%) and well above the random-graph control
(52.9\%), and it is best on nearly every suite. The \emph{fixed} biology
prior, by contrast, is the honest negative: at 39.5\% single-cell macro-F1 it
...
the bio-initialised graph improves on the general learned graph by $+1.1$ points (67.5\% vs.\ 66.5\%), so an explicit biological warm-start still adds signal on top of end-to-end learning. The lesson is that biology helps
...
\toprule
Dataset & None & Random & Biology & Learned & Learned$_{bio}$ \\
\midrule
\multicolumn{6}{l}{\emph{Single-cell (genomap)}} \\
\quad Baron & 59.7\,$\pm$\,4.7 & 60.6\,$\pm$\,4.0 & 69.7\,$\pm$\,2.5 & 79.1\,$\pm$\,2.8 & 82.7\,$\pm$\,3.5 \\
\quad Lung & 71.6\,$\pm$\,1.3 & 69.6\,$\pm$\,2.5 & 72.3\,$\pm$\,2.2 & 79.1\,$\pm$\,1.2 & 79.3\,$\pm$\,0.8 \\
\quad Muraro & 69.7\,$\pm$\,4.9 & 67.4\,$\pm$\,6.4 & 2.1\,$\pm$\,0.0 & 75.3\,$\pm$\,6.4 & 76.3\,$\pm$\,5.7 \\
\quad Oeso. & 56.7\,$\pm$\,3.4 & 55.4\,$\pm$\,3.2 & 59.0\,$\pm$\,3.4 & 69.6\,$\pm$\,1.4 & 70.0\,$\pm$\,1.1 \\
\quad Seger. & 56.5\,$\pm$\,7.6 & 49.5\,$\pm$\,9.9 & 0.1\,$\pm$\,0.0 & 71.4\,$\pm$\,5.3 & 69.7\,$\pm$\,5.5 \\
\quad Spleen & 48.9\,$\pm$\,3.0 & 48.1\,$\pm$\,2.6 & 56.7\,$\pm$\,2.2 & 58.2\,$\pm$\,0.9 & 58.7\,$\pm$\,1.1 \\
\quad T-cell & 49.9\,$\pm$\,4.0 & 49.6\,$\pm$\,3.0 & 61.0\,$\pm$\,3.6 & 68.9\,$\pm$\,1.0 & 68.8\,$\pm$\,1.0 \\
\quad Wang & 18.0\,$\pm$\,8.5 & 16.5\,$\pm$\,3.1 & 16.1\,$\pm$\,5.6 & 31.9\,$\pm$\,7.2 & 34.8\,$\pm$\,5.6 \\
\quad Xin & 59.3\,$\pm$\,5.8 & 59.6\,$\pm$\,9.4 & 18.6\,$\pm$\,0.0 & 64.7\,$\pm$\,9.4 & 67.4\,$\pm$\,6.7 \\
\midrule
\multicolumn{6}{l}{\emph{Multi-omics (Reactome/P-NET)}} \\
\quad Prostate & 60.3\,$\pm$\,2.9 & 64.1\,$\pm$\,4.4 & 65.2\,$\pm$\,3.3 & 66.0\,$\pm$\,3.7 & 62.6\,$\pm$\,5.1 \\
\quad BLCA & 44.4\,$\pm$\,5.0 & 44.0\,$\pm$\,6.0 & 43.7\,$\pm$\,5.9 & 49.2\,$\pm$\,4.3 & 49.5\,$\pm$\,5.8 \\
\quad STAD & 51.6\,$\pm$\,5.9 & 49.1\,$\pm$\,5.1 & 49.2\,$\pm$\,5.3 & 52.0\,$\pm$\,5.8 & 50.2\,$\pm$\,4.3 \\
\quad BRCA & 19.6\,$\pm$\,4.6 & 18.3\,$\pm$\,5.4 & 19.5\,$\pm$\,3.1 & 16.5\,$\pm$\,2.1 & 18.0\,$\pm$\,4.5 \\
\midrule
\textbf{Mean macro-F1} & \textbf{51.2} & \textbf{50.1} & \textbf{41.0} & \textbf{60.1} & \textbf{60.6} \\
\textbf{Mean accuracy} & \textbf{66.0} & \textbf{63.6} & \textbf{54.5} & \textbf{72.0} & \textbf{72.0} \\
\bottomrule
\end{tabular}}
\caption{\textbf{Biology-informed routing: fixed vs.\ learned vs.\ bio-initialised.}
Test macro-F1 (mean$\pm$std over 10 seeds) for five depth-router graph
...
Bottom rows: mean over all 13 datasets.}
\label{tab:learned}
\end{table}
...
13 datasets. Tying the $K$ independent layers into one weight-shared block makes
...
\midrule
Vanilla transformer ($K$ independent layers) & 4$\times$ & 1.00$\times$ & 66.2\,$\pm$\,19.8 & 51.4\,$\pm$\,16.8 \\
Recursive, fixed depth & 1$\times$ & 1.00$\times$ & 67.1\,$\pm$\,19.7 & 52.3\,$\pm$\,17.1 \\
Adaptive MoR, token-choice & 1$\times$ & 0.56$\times$ & 67.2\,$\pm$\,20.8 & 53.6\,$\pm$\,18.4 \\
Adaptive MoR, expert-choice (\textbf{ours}) & 1$\times$ & 0.62$\times$ & 66.6\,$\pm$\,19.2 & 50.4\,$\pm$\,17.1 \\
\bottomrule
\end{tabular}}
...
13 datasets. Weight sharing removes the $4\times$ parameter cost and
adaptive routing removes $\sim$38\% of the FLOPs, both at matched accuracy.}
\label{tab:ladder}
\end{table}
...
\quad Wang & 26.7\,$\pm$\,8.9 & 25.0\,$\pm$\,14.3 & 23.3\,$\pm$\,8.0 & 23.4\,$\pm$\,7.0 & 19.2\,$\pm$\,3.5 \\
...
\quad BRCA & 41.6\,$\pm$\,2.9 & 48.2\,$\pm$\,2.6 & 47.1\,$\pm$\,4.1 & 48.3\,$\pm$\,7.2 & 43.5\,$\pm$\,3.6 \\
\midrule
\textbf{Mean macro-F1} & \textbf{40.5} & \textbf{43.5} & \textbf{51.4} & \textbf{55.6} & \textbf{59.9} \\
\bottomrule
\end{tabular}}
...
most of the full-gene accuracy. Bottom row: mean over all 13 datasets.}
\label{tab:token}
\end{table}
...
configurations, averaged over all 13 datasets. Crucially, this includes the
...
1.46 vs.\ 1.33; ECE 0.107 vs.\ 0.091, both
...
accuracy-winning learned graph (NLL 1.46$\to$0.79, a
$\sim$46\% reduction, comparable to the vanilla transformer's
1.33$\to$0.85). ECE improves more modestly and less uniformly,
...
\midrule
Vanilla ($K$ independent layers) & 1.33\,$\pm$\,1.16 & 0.85\,$\pm$\,0.35 & 0.091\,$\pm$\,0.066 & 0.080\,$\pm$\,0.070 & 0.713 \\
Shared recursion, no prior & 1.33\,$\pm$\,1.11 & 0.85\,$\pm$\,0.35 & 0.101\,$\pm$\,0.077 & 0.094\,$\pm$\,0.077 & 0.700 \\
Fixed-depth recursion & 1.37\,$\pm$\,1.44 & 0.78\,$\pm$\,0.35 & 0.101\,$\pm$\,0.080 & 0.069\,$\pm$\,0.050 & 0.707 \\
Single pass ($K{=}1$) & 3.64\,$\pm$\,4.65 & 1.40\,$\pm$\,2.02 & 0.178\,$\pm$\,0.192 & 0.106\,$\pm$\,0.102 & 0.680 \\
Adaptive MoR & 1.47\,$\pm$\,1.18 & 0.85\,$\pm$\,0.36 & 0.110\,$\pm$\,0.086 & 0.094\,$\pm$\,0.075 & 0.701 \\
Fixed biology prior & 1.76\,$\pm$\,1.23 & 1.72\,$\pm$\,2.69 & 0.091\,$\pm$\,0.097 & 0.086\,$\pm$\,0.130 & 0.646 \\
Learned routing graph & 1.46\,$\pm$\,1.20 & 0.79\,$\pm$\,0.39 & 0.107\,$\pm$\,0.059 & 0.118\,$\pm$\,0.129 & 0.682 \\
\bottomrule
\end{tabular}}
\caption{\textbf{Calibration, raw and temperature-scaled.} NLL and ECE per configuration
(mean over all 13 datasets, 3 seeds), each shown raw and after
...
computation rather than only how its results are read. Across 13 single-cell
and multi-omics datasets we find that a \emph{learned} routing graph is the decisive
positive (single-cell macro-F1 66.5\%, $+12.0$ over a
...
\label{app:data}
We use $9$ genomap single-cell datasets \cite{islam2023cartography} converted to
plain CSV (expression + labels + stratified split) -- Baron, Lung, Muraro, Oesophagus,
Segerstolpe, Spleen, T-cell, Wang and Xin -- and $4$ Reactome/P-NET multi-omics
...
Wang & single-cell & 457 & 2{,}000 & 7 \\
Xin & single-cell & 1{,}492 & 2{,}000 & 4 \\
\midrule
Prostate & multi-omics & 1{,}011 & 1{,}223 & 2 \\
BLCA & multi-omics & 404 & 1{,}258 & 2 \\
STAD & multi-omics & 414 & 1{,}258 & 2 \\
BRCA & multi-omics & 518 & 1{,}260 & 5 \\
\bottomrule
\end{tabular}}
\caption{The 13 datasets used throughout: $9$ genomap single-cell suites
and $4$ Reactome/P-NET multi-omics cohorts. Counts are read directly from the
result files.}
\label{tab:datasets}
\end{table}
