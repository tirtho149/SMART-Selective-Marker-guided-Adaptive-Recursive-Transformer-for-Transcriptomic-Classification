...
\node[stage, below=24mm of inp] (shared) {{\large\textcolor{accentB}{\faRedo}}\\[2pt]\textbf{Shared Block}\\[1pt]{\scriptsize\textcolor{subcap}{$f_\theta$ applied $\times K$}}};
...
\midrule
\multicolumn{5}{l}{\emph{Single-cell genomap --- accuracy \%, 5 seeds}}\\
\midrule
\multirow{2}{*}{Genomap}
