...
\toprule
& \multicolumn{5}{c}{Routing prior} & \multicolumn{3}{c}{Architecture} \\
\cmidrule(lr){2-6}\cmidrule(lr){7-9}
Dataset & None & Random & Biology & Learned & Learn$_{bio}$ & Vanilla & Recursive & MoR \\
\midrule
\multicolumn{9}{l}{\emph{Single-cell (genomap)}} \\
\quad Baron & 59.7/83 & 60.6/81 & 69.7/89 & 79.1/95 & 82.7/96 & 62.5/85 & 63.0/86 & 58.6/83 \\
\quad Lung & 71.6/78 & 69.6/77 & 72.3/81 & 79.1/87 & 79.3/87 & 70.4/79 & 73.6/81 & 71.4/79 \\
\quad Muraro & 69.7/83 & 67.4/80 & 2.1/10 & 75.3/87 & 76.3/90 & 67.8/78 & 73.2/88 & 68.9/82 \\
\quad Oeso. & 56.7/81 & 55.4/80 & 59.0/83 & 69.6/87 & 70.0/88 & 55.8/80 & 55.0/81 & 55.0/80 \\
\quad Seger. & 56.5/75 & 49.5/64 & 0.1/0 & 71.4/91 & 69.7/90 & 58.1/82 & 59.1/84 & 56.9/83 \\
\quad Spleen & 48.9/56 & 48.1/55 & 56.7/65 & 58.2/69 & 58.7/68 & 48.4/56 & 49.0/57 & 49.0/57 \\
\quad T-cell & 49.9/65 & 49.6/64 & 61.0/74 & 68.9/83 & 68.8/82 & 48.9/65 & 48.5/63 & 49.2/65 \\
\quad Xin & 59.3/84 & 59.6/81 & 18.6/59 & 64.7/85 & 67.4/85 & 65.9/88 & 66.1/89 & 68.2/89 \\
\midrule
\multicolumn{9}{l}{\emph{Multi-omics (Reactome/P-NET)}} \\
\quad Prostate & 60.3/66 & 64.1/69 & 65.2/69 & 66.0/68 & 62.6/65 & 54.5/64 & 57.9/62 & 53.8/68 \\
\quad BLCA & 44.4/57 & 44.0/55 & 43.7/55 & 49.2/52 & 49.5/55 & 40.0/67 & 44.5/64 & 42.2/60 \\
\quad STAD & 51.6/54 & 49.1/52 & 49.2/52 & 52.0/54 & 50.2/51 & 53.0/55 & 50.0/52 & 43.9/47 \\
\midrule
\textbf{Mean} & \textbf{57.1/71} & \textbf{56.1/69} & \textbf{45.2/58} & \textbf{66.7/78} & \textbf{66.8/78} & \textbf{56.8/73} & \textbf{58.2/73} & \textbf{56.1/72} \\
\bottomrule
\end{tabular}}
\caption{\textbf{Main results: routing prior and architecture, per dataset.} Each cell is
\emph{macro-F1 / accuracy} (\%), mean over seeds (10 for routing,
3 for architecture). \emph{Routing} holds the architecture fixed and varies the
...
\begin{tabular}{lcccc}
\toprule
& \multicolumn{2}{c}{Cost (design)} & \multicolumn{2}{c}{Suite mean (11)} \\
\cmidrule(lr){2-3}\cmidrule(lr){4-5}
Configuration & Params & FLOPs & Accuracy & Macro-F1 \\
\midrule
Vanilla transformer ($K$ independent layers) & 4$\times$ & 1.00$\times$ & 72.6\,$\pm$\,12.0 & 56.8\,$\pm$\,10.2 \\
Recursive, fixed depth & 1$\times$ & 1.00$\times$ & 73.3\,$\pm$\,13.7 & 58.2\,$\pm$\,10.0 \\
Adaptive MoR, token-choice & 1$\times$ & 0.56$\times$ & 73.8\,$\pm$\,14.2 & 59.7\,$\pm$\,11.9 \\
Adaptive MoR, expert-choice (\textbf{ours}) & 1$\times$ & 0.62$\times$ & 72.2\,$\pm$\,13.7 & 56.1\,$\pm$\,10.9 \\
\bottomrule
\end{tabular}}
...
11 datasets. Weight sharing removes the $4\times$ parameter cost and
...
\midrule
Vanilla ($K$ independent layers) & 1.30\,$\pm$\,1.26 & 0.73\,$\pm$\,0.22 & 0.088\,$\pm$\,0.071 & 0.073\,$\pm$\,0.074 & 0.723 \\
Shared recursion, no prior & 1.29\,$\pm$\,1.20 & 0.72\,$\pm$\,0.22 & 0.083\,$\pm$\,0.070 & 0.076\,$\pm$\,0.070 & 0.725 \\
Fixed-depth recursion & 1.36\,$\pm$\,1.56 & 0.67\,$\pm$\,0.24 & 0.090\,$\pm$\,0.082 & 0.061\,$\pm$\,0.050 & 0.731 \\
Single pass ($K{=}1$) & 2.71\,$\pm$\,3.31 & 0.76\,$\pm$\,0.20 & 0.145\,$\pm$\,0.165 & 0.073\,$\pm$\,0.061 & 0.712 \\
Adaptive MoR & 1.45\,$\pm$\,1.28 & 0.72\,$\pm$\,0.22 & 0.093\,$\pm$\,0.083 & 0.077\,$\pm$\,0.070 & 0.728 \\
Fixed biology prior & 1.79\,$\pm$\,1.36 & 0.75\,$\pm$\,0.25 & 0.070\,$\pm$\,0.091 & 0.041\,$\pm$\,0.048 & 0.678 \\
Learned routing graph & 1.31\,$\pm$\,1.20 & 0.67\,$\pm$\,0.29 & 0.092\,$\pm$\,0.049 & 0.106\,$\pm$\,0.136 & 0.704 \\
\bottomrule
\end{tabular}}
\caption{\textbf{Calibration, raw and temperature-scaled.} NLL and ECE per configuration
(mean over all 11 datasets, 3 seeds), each shown raw and after
