...
for the multi-omics binary cohorts, full Table-2 ladder. Reads results_repro/ladder/.
...
def cell(t,a):
    f=f"{ROOT}/results_repro/ladder/{t}_{a}/{t}__{a}.json"
...
print("wrote paper/cv5_posf1_table.tex ; done cells:",
      sum(1 for t,_ in COH for a,_ in ARMS if os.path.exists(f"{ROOT}/results_repro/ladder/{t}_{a}/{t}__{a}.json")),"/50")
