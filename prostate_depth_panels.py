...
vs token-choice routing, with real Reactome pathway names -> results_depth/prostate_panels.json.
...
Path("results_depth").mkdir(exist_ok=True)
json.dump(out, open("results_depth/prostate_panels.json", "w"))
print("wrote results_depth/prostate_panels.json")
