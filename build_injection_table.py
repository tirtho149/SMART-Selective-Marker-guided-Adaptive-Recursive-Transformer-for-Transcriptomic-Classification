...
# multi-omics: (display, task-stem)
MO = [("Prostate","prostate"),("BLCA","blca"),("STAD","stad"),("BRCA","brca"),
...
def sc_cell(ds_dir, sc_mode):
    return _read(f"results_cv5/biomor_canonical/{ds_dir}/{sc_mode}_cv.json")


def mo_cell(stem, mo_sub):
    return _read(f"results_cv5/inject_mo/{mo_sub}/{stem}__*_cv.json")
